...
@@ -0,0 +1 @@
+INCLUDE 'hello_constants.INc'
Index: added_directory/foo03-branch-diff-bdi-wc-changes
===================================================================
--- added_directory/foo03-branch-diff-bdi-wc-changes	(.../$ROOT_URL/trunk)	(revision 0)
+++ added_directory/foo03-branch-diff-bdi-wc-changes	(revision 0)
@@ -0,0 +1 @@
+foo
Index: added_directory/hello_constants_dummy.inc
===================================================================
