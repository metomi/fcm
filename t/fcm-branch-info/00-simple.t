...
svn switch $ROOT_URL/branches/dev/Share/sibling_branch_test
svn merge $ROOT_URL/trunk
svn commit -m "Merged trunk into sibling branch"
svn switch $ROOT_URL/branches/dev/Share/branch_test
svn merge $ROOT_URL/branches/dev/Share/sibling_branch_test
svn commit -m "Merged sibling into test branch"
svn switch $ROOT_URL/branches/dev/Share/sibling_branch_test
FILE_LIST=$(find . -type f | sed "/\.svn/d" | sort | head -5)
TMPFILE=$(mktemp)
for FILE in $FILE_LIST; do 
